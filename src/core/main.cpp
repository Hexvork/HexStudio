...
void printHelp()
{
	printf( "HexStudio %s\n"
		...
		"Actions:\n"
		"  <no action> [options...] [<project>]  Start HexStudio in normal GUI mode\n"
...
int main( int argc, char * * argv )
{
	...
	{
		printf( "HexStudio cannot be run as root.\nUse \"--allowroot\" to override.\n\n" );
		return EXIT_FAILURE;
	}
#endif
		...
		if( recoveryFilePresent )
		{
			...
			mb.setText( QString(
				...
				MainWindow::tr( "There is a recovery file present. "
					...
					"properly or another instance of HexStudio is "
				...
				MainWindow::tr( "Recover the file. Please don't run "
					"multiple instances of HexStudio when you do this." ),
